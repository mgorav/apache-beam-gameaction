 ...
 * </pre>
 */
public class GameActionPipeline {
  ...
  public static void main(String[] args) throws Exception {
    ...
    GameInfoPipelineOptions options = PipelineOptionsFactory.fromArgs(args).withValidation().as(GameInfoPipelineOptions.class);
    Pipeline pipeline = Pipeline.create(options);

    pipeline
        // Generate a bounded set of data.
        .apply(new InputSimulator.BoundedGenerator())
        ...
        .apply(new OutputSimulator.WriteUserScoreSums(options.getOutputPrefix()));
